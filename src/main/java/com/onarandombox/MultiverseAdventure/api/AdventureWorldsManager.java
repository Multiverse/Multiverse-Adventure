...
public interface AdventureWorldsManager {
     ...
     * @return The MVAdventureWorld-Object
     */
     ...
     * 
     * @param name The name of that world.
     ...
     * 
     * @param name The name of that world.
     * @param noreset If the world shouldn't be reset.
     * @return True if success, false if failed.
     */
     ...
     * 
     * @param name The name of the world
     * @param sender The CommandSender that receives the notifications
     */
    public abstract void createWorldWithNotifications(String name, CommandSender sender);
     ...
     * 
     * @param name The name of the world.
     * @param sender The CommandSender that receives notifications
     */
    public abstract void deleteWorld(final String name, final CommandSender sender);
